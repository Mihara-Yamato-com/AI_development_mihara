...
全体を1つの作業ブランチ`feature/5-design-overhaul`にまとめ、以下A〜Gの順で1コミットずつ進める
(範囲が広いため、Phase3同様に機能ごとに動作確認しながら進める。全て完了した時点でdevelopへの1回のPRとしてまとめて通告する)。

**進捗状況**:
- [x] 5-A: 完了(実装日: 2026-07-15)
- [ ] 5-B: 未着手
- [ ] 5-C: 未着手
- [ ] 5-D: 未着手
- [ ] 5-E: 未着手
